...
export default function SideNav() {
  return (
    <div className="flex h-full flex-col px-3 py-4 md:px-2">
      <div className="h-20 md:h-30 mb-2 flex items-end justify-start rounded-md bg-[#FFBF1F] md:p-4">
        <BoltIcon className="h-20 w-20 xs:h-15 xs:w-15 text-white font-bold" />
